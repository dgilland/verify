...
METHOD_ALIAS_CASES = [
    ...
    (v.NotLength, v.has_not_length),
    (v.Equal, v.to_be_equal),
    (v.Equal, v.is_equal),
    (v.NotEqual, v.to_not_be_equal),
    (v.NotEqual, v.is_not_equal),
    (v.Match, v.to_be_match),
    (v.Match, v.is_match),
    (v.Match, v.matches),
    (v.NotMatch, v.to_not_be_match),
    (v.NotMatch, v.is_not_match),
    (v.NotMatch, v.not_matches),
    (v.Is, v.to_be),
    (v.Is, v.is_),
    (v.IsNot, v.to_not_be),
    (v.IsNot, v.is_not),

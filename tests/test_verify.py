...
@pytest.mark.parametrize('meth,value,arg', [
    ...
    (v.InstanceOf, True, Arg(bool)),
    (v.InstanceOf, 'abc', Arg(str)),
    (v.InstanceOf, 1, Arg(int)),
    (v.Truthy, True, Arg()),
    (v.Truthy, 1, Arg()),
    (v.Truthy, 'verify', Arg()),
    (v.Falsy, False, Arg()),
    ...
    (v.NotInstanceOf, True, Arg(str)),
    (v.NotInstanceOf, 'abc', Arg(int)),
    (v.NotInstanceOf, 1, Arg(str)),
...
@pytest.mark.parametrize('meth,value,arg', [
    ...
    (v.InstanceOf, True, Arg(str)),
    (v.InstanceOf, 'abc', Arg(int)),
    (v.InstanceOf, 1, Arg(str)),
    (v.Truthy, False, Arg()),
    (v.Truthy, None, Arg()),
    (v.Truthy, 0, Arg()),
    (v.Truthy, '', Arg()),
    ...
    (v.NotInstanceOf, True, Arg(bool)),
    (v.NotInstanceOf, 'abc', Arg(str)),
    (v.NotInstanceOf, 1, Arg(int)),
